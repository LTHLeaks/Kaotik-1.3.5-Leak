...
public class CustomFont
{
    ...
    public void drawString(final String text, final double x, final double y, final int color) {
        ...
        GlStateManager.func_179139_a(0.25, 0.25, 0.25);
        ...
        for (final char ch : text.toCharArray()) {
            if (Character.getNumericValue(ch) >= this.charLocations.length) {
                GL11.glEnd();
                GlStateManager.func_179139_a(4.0, 4.0, 4.0);
                Minecraft.func_71410_x().field_71466_p.func_175065_a(String.valueOf(ch), (float)currX * 0.25f + 1.0f, 2.0f, color, false);
                currX += Minecraft.func_71410_x().field_71466_p.func_78256_a(String.valueOf(ch)) * 4.0;
                GlStateManager.func_179139_a(0.25, 0.25, 0.25);
                GlStateManager.func_179144_i(this.textureID);
                GlStateManager.func_179131_c(red, green, blue, alpha);
                GL11.glBegin(7);
